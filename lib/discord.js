...
export const COMMANDS = [
  ...
  { name: 'x', desc: 'Scrape an X / Twitter post and research it', arg: { name: 'post', desc: 'X post URL or id', required: true } },
  { name: 'now', desc: 'Run a research cycle now' },
  { name: 'themes', desc: 'Show the active themes and their read surfaces' },
